...
//초기화면 pie chart
d3.csv('./csv/killCounts/mirama/DMRifle_MR.csv').then(pie_chart);
...
const btnPie = document.querySelector(".btn-pie");
        ...
        dmRifle.onclick = function() {
          let data = './csv/killCounts/mirama/DMRifle_MR.csv';
        ...
        pistol.onclick = function() {
          let data = './csv/killCounts/mirama/pistol_MR.csv';
          let data2 = './csv/weapons/Pistol.csv';
          makePieChart(data,data2);
        }

        rifle.onclick = function() {
          let data = './csv/killCounts/mirama/rifle_MR.csv';
          let data2 = './csv/weapons/Rifle.csv';
          makePieChart(data,data2);
        }

        shot.onclick = function() {
          let data = './csv/killCounts/mirama/shot_MR.csv';
          let data2 = './csv/weapons/Shotgun.csv';
          makePieChart(data,data2);
        }

        sniper.onclick = function() {
          let data = './csv/killCounts/mirama/sniper_MR.csv';
        ...
        sub.onclick = function() {
          let data = './csv/killCounts/mirama/sub_MR.csv';
