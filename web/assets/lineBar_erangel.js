d3.csv('./csv/upperLowerRank/solo_compare_ERANGEL.csv').then(chart_solo);
...
d3.csv('./csv/upperLowerRank/duo_compare_ERANGEL.csv').then(chart_duo);
...
d3.csv('./csv/upperLowerRank/squad_compare_ERANGEL.csv').then(chart_squad);
